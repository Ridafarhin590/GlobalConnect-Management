...
const Chatbot = () => {
  ...
  const [messages, setMessages] = useState([
    { role: "assistant", content: "Hi there! 👋 I'm your GlobalConnect Assistant. I'm here to help you with international trade and our platform. What would you like to know about?" }
  ])
        ...
        <div className="w-80 h-[500px] bg-white shadow-2xl rounded-2xl border border-gray-200 flex flex-col overflow-hidden animate-in slide-in-from-bottom-4 duration-300">
          ...
          <div className="bg-gradient-to-r from-blue-600 to-blue-700 text-white p-4 flex justify-between items-center">
            <div className="flex items-center gap-2">
              ...
              <span className="font-medium">GlobalConnect Assistant</span>
            </div>
            <button 
