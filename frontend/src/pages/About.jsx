      ...
      <section className="bg-slate-50 pt-10 pb-16 lg:pt-20">
        <div className="max-w-5xl mx-auto px-4 sm:px-6 lg:px-8 text-center">
          ...
          <h1 className="text-4xl sm:text-5xl font-bold text-gray-900 mb-6">
            About <span className="text-blue-600">GlobalConnect</span>
          </h1>
          <p className="text-lg text-gray-600 mb-8 max-w-2xl mx-auto leading-relaxed">
            GlobalConnect is dedicated to connecting global export partners for seamless international commerce. Our mission is to empower exporters, buyers, and shippers to grow their businesses with confidence, security, and ease.
          </p>
        </div>
      </section>
      ...
      <section className="py-16 lg:py-24 bg-blue-600">
        <div className="max-w-4xl mx-auto px-4 sm:px-6 lg:px-8 text-center">
          ...
          <p className="text-xl text-blue-100 mb-8 leading-relaxed">
            Become part of GlobalConnect and start trading internationally with confidence.
          </p>
          {!user && (
