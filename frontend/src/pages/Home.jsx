          ...
          <div className="grid lg:grid-cols-3 gap-8 lg:gap-12">
            ...
            <div className="group">
              <div className="bg-white border border-gray-200 rounded-lg p-8 h-full hover:shadow-lg transition-shadow duration-300">
                ...
                <h3 className="text-xl font-semibold text-gray-900 mb-4">Export Products</h3>
                <p className="text-gray-600 mb-6 leading-relaxed">
                 List your products and connect with verified international buyers. Expand your business globally through a secure digital marketplace.
                </p>
                ...
                <div className="space-y-3 mb-8">
                  ...
                  <div className="flex items-start">
                    <Check className="h-5 w-5 text-green-500 mr-3 mt-0.5 flex-shrink-0" />
                    <span className="text-sm text-gray-600">Simplified international trade management</span>
                  </div>
                </div>
            ...
            <div className="group">
              <div className="bg-white border border-gray-200 rounded-lg p-8 h-full hover:shadow-lg transition-shadow duration-300">
                ...
                <p className="text-gray-600 mb-6 leading-relaxed">
                 Discover quality products from trusted exporters. Compare offerings, request quotations, and purchase with confidence.
                </p>
                
                <div className="space-y-3 mb-8">
                  <div className="flex items-start">
                    <Check className="h-5 w-5 text-green-500 mr-3 mt-0.5 flex-shrink-0" />
                    <span className="text-sm text-gray-600">Browse verified exporters worldwide</span>
                  </div>
                  <div className="flex items-start">
                    <Check className="h-5 w-5 text-green-500 mr-3 mt-0.5 flex-shrink-0" />
                    <span className="text-sm text-gray-600">Compare products and pricing</span>
                  </div>
                  <div className="flex items-start">
                    <Check className="h-5 w-5 text-green-500 mr-3 mt-0.5 flex-shrink-0" />
                    <span className="text-sm text-gray-600">Safe procurement for global businesses</span>
                  </div>
                </div>
      ...
      <section className="py-16 lg:py-24 bg-blue-600">
        <div className="max-w-4xl mx-auto px-4 sm:px-6 lg:px-8 text-center">
          ...
          <p className="text-xl text-blue-100 mb-8 leading-relaxed">
            Join GlobalConnect to expand globally. <br></br>
